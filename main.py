...
def start_training(char_name: str, char_class: str) -> str:
    """Suggest trainining mode or skip taining mode."""
    if char_class == 'warrior':
...
if __name__ == '__main__':
    """Greet player. Suggest name and character creation.
    Suggest training mode.
    """
    run_screensaver()
